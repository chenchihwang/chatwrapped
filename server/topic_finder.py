...
def find_favorite_topic(username, file_path):
    ...
    favorite_label = auto_label_topic_with_hf(keywords, topn=10)

    return extracted_keywords, favorite_label

# Example usage:
username = "fnweeaboo"
file_path = "chat_history.json"
keywords, label = find_favorite_topic(username, file_path)
print("\nFavorite Topic Details (Embedding-Based Clustering with KeyBERT and TF-IDF + Sentiment):")
print(f"One-word label: {label}")
